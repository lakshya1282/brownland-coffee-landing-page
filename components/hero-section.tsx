...
export function HeroSection() {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-safe">
      ...
      <div className="relative z-10 text-center px-5 sm:px-6 max-w-4xl mx-auto">
        ...
        <h1
          className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-4 sm:mb-6 leading-tight aos-fade-up"
          style={{ transitionDelay: "0.1s" }}
        >
          Brownland
          <span className="block text-primary">Coffee</span>
        </h1>
        <p
        ...
        <div
          className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center aos-fade-up"
      ...
      <div className="absolute bottom-24 sm:bottom-20 left-1/2 -translate-x-1/2 flex gap-2 z-10">
